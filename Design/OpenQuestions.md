...
| Q20 | Nothing in the design made a destroyed device or structure explode. What comes apart when one dies, and how finely? | **Triangle-level, as Species does it** (owner, 2026-09-19): the dead object's own model shatters into individually tumbling triangles that fall and fade over five seconds, with the particle burst beside it and the wreck underneath | Yes | `GameDesign.md` §8, §11, §12; `SpeciesLook.md` §8; `TechnicalDesign.md` §5.3 and §6.2; `SpeciesLineage.md` §5; `m2-skirmish/T12` builds it |
...
### Q20 — When a device or structure dies, what comes apart, and how finely? (raised 2026-09-19, answered 2026-09-19)
