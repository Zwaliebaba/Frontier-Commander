...
| [`OpenQuestions.md`](OpenQuestions.md) | The sixteen questions put to the owner on 2026-09-17, the six the external review raised and Q17 on the sky's scaling of 2026-09-18, each with the answer and where it is recorded; the form for adding one | Answered |
