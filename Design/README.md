...
| [`OpenQuestions.md`](OpenQuestions.md) | The sixteen questions put to the owner on 2026-09-17, the six the external review raised and Q17 on the sky's scaling of 2026-09-18, each with the answer and where it is recorded; Q18, terrain regions in one landscape, raised 2026-09-18 and open; the form for adding one | One open |
| [`ADR/`](ADR/README.md) | Engineering decisions taken while building, one file per decision, numbered from `ADR-001` | ADR-001 |
