...
| [`OpenQuestions.md`](OpenQuestions.md) | The sixteen questions put to the owner on 2026-09-17 and the six the external review raised, each with the answer and where it is recorded; Q17, the sky's scaling, raised 2026-09-18 and open; the form for adding one | One open |
